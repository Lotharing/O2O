...
public class WechatUtil {
	...
	public static UserAccessToken getUserAccessToken(String code) throws IOException {
		// 测试号信息里的appId
		String appId = "wxd0689996c13262bc";
		log.debug("appId:" + appId);
		// 测试号信息里的appsecret
		String appsecret = "0f36828f7411d7fa46ed87ddb1c4d69a";
	...
	/**
	 * 将WechatUser实体类的信息转换为PersonInfo的信息并返回PersonInfo实体类
	 * @param user
	 * @return
	 */
